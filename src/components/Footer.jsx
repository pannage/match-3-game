        ...
        return (<footer className="footer">
            <div className="wrap">
                ...
                <div className="social-list">
                    <a href="https://github.com/ekoniuh" className="social-list__item" alt="github" target="_blank" rel="noreferrer">
                    ...
                    <a href="https://github.com/zrudikkk" className="social-list__item" alt="github" target="_blank" rel="noreferrer">
